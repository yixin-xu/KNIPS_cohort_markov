...
generate_transition_matrices <- function(input_parameters, n_cycles=50, sensitivity = NULL) {
  ...
  first_mortality = rbeta(n_samples, as.numeric(mortality[which(grepl(paste0(initial_age," ", gender),mortality$Primary)),7]), (as.numeric(mortality[which(grepl(paste0(initial_age," ", gender),mortality$Primary)),2])-as.numeric(mortality[which(grepl(paste0(initial_age," ", gender),mortality$Primary)),7])))
  second_mortality = rbeta(n_samples, as.numeric(mortality[which(grepl(paste0(initial_age," ", gender),mortality$Primary)),12]), (as.numeric(mortality[which(grepl(paste0(initial_age," ", gender),mortality$Primary)),2])-as.numeric(mortality[which(grepl(paste0(initial_age," ", gender),mortality$Primary)),12])))
  higher_mortality = rbeta(n_samples, as.numeric(mortality[which(grepl(paste0(initial_age," ", gender),mortality$Primary)),12]), (as.numeric(mortality[which(grepl(paste0(initial_age," ", gender),mortality$Primary)),2])-as.numeric(mortality[which(grepl(paste0(initial_age," ", gender),mortality$Primary)),12])))
