generate_input_parameters <- function(n_samples, treatment_names = treatment_names, 
  ...
  if ("implant_cost_Implant MoP Cem CR_Fix Mono" %in% colnames(input_parameters)){
    input_parameters[ , "implant_cost_Implant MoP Cem CR_Fix Mono"] <- rep(as.numeric(costs[1,2]), n_samples) }
  if ("implant_cost_Implant MoP Cem CR_Fix Mod" %in% colnames(input_parameters)){
    input_parameters[ , "implant_cost_Implant MoP Cem CR_Fix Mod"] <- rep(as.numeric(costs[2,2]), n_samples) }
  if ("implant_cost_Implant MoP Cem CR_Mob Mod" %in% colnames(input_parameters)){
    input_parameters[ , "implant_cost_Implant MoP Cem CR_Mob Mod"] <-  rep(as.numeric(costs[3,2]), n_samples) }
  if ("implant_cost_Implant MoP Cem PS_Fix Mod" %in% colnames(input_parameters)){
    input_parameters[ , "implant_cost_Implant MoP Cem PS_Fix Mod"] <- rep(as.numeric(costs[4,2]), n_samples) }
  if ("implant_cost_Implant MoP Cem PS_Mob Mod" %in% colnames(input_parameters)){
    input_parameters[ , "implant_cost_Implant MoP Cem PS_Mob Mod"] <- rep(as.numeric(costs[5,2]), n_samples) }
  if ("implant_cost_Implant MoP Cem Con_Con Mod" %in% colnames(input_parameters)){
    input_parameters[ , "implant_cost_Implant MoP Cem Con_Con Mod"] <- rep(as.numeric(costs[6,2]), n_samples) }
  if ("implant_cost_Implant MoP Unc CR_Fix Mod" %in% colnames(input_parameters)){
    input_parameters[ , "implant_cost_Implant MoP Unc CR_Fix Mod"] <- rep(as.numeric(costs[7,2]), n_samples) }
  if ("implant_cost_Implant MoP Unc CR_Mob Mod" %in% colnames(input_parameters)){
    input_parameters[ , "implant_cost_Implant MoP Unc CR_Mob Mod"] <- rep(as.numeric(costs[8,2]), n_samples) }
  if ("implant_cost_Implant MoP Unc PS_Fix Mod" %in% colnames(input_parameters)){
    input_parameters[ , "implant_cost_Implant MoP Unc PS_Fix Mod"] <- rep(as.numeric(costs[9,2]), n_samples) }
  if ("implant_cost_Implant MoP Hyb CR_Fix Mod" %in% colnames(input_parameters)){
    input_parameters[ , "implant_cost_Implant MoP Hyb CR_Fix Mod"] <- rep(as.numeric(costs[10,2]), n_samples) } 
  if ("implant_cost_Implant OX Cem CR_Fix Mod" %in% colnames(input_parameters)){
    input_parameters[ , "implant_cost_Implant OX Cem CR_Fix Mod"] <- rep(as.numeric(costs[11,2]), n_samples) } 
  if ("implant_cost_Implant OX Cem PS_Fix Mod" %in% colnames(input_parameters)){
    input_parameters[ , "implant_cost_Implant OX Cem PS_Fix Mod"] <- rep(as.numeric(costs[12,2]), n_samples) } 
